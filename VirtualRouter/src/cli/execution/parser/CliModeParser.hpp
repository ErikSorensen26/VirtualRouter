...
#include "cli/execution/parser/Command.hpp" // IWYU pragma: keep
#include "cli/execution/parser/SubCommand.hpp" // IWYU pragma: keep
 ...
 */
template <typename T>
concept is_cli_mode_v = std::derived_from<T, ::cli::CliModeParserFlag>;
