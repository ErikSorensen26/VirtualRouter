...
public:
     ...
     */
    bool saveCommand(std::vector<std::string>& oldCommand, const std::vector<std::string>& command, bool changeMode, bool exitMode, bool isList); 
     ...
     */
    bool deleteConfig(std::vector<std::string>& oldCommand, const std::vector<std::string>& command, bool isList);
