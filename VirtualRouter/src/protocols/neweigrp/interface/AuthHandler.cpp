...
#include "EigrpInterfaceAuth.h"

namespace Protocol
{
    void EigrpInterface::setKeyChain(uint8_t* keyId, const std::string* key, EigrpConfigs::AuthType* type, bool enable)
    {
        // Validate neighbor
        {
    ...
    uint8_t EigrpInterface::buildAuthTLV(uint8_t* out)
    {
        uint8_t keyId;
