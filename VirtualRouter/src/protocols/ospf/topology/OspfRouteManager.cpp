...
static std::optional<std::pair<uint64_t, std::vector<OspfNextHop>>> resolveToAbr(OspfArea& area, const SpfResult& spf, uint32_t abrRid, RouteManager::NhCache& nhCache)
{
...
template void RouteManager::deriveIntraAreaRoutes<PolicyV2>(const SpfResult&, std::vector<std::pair<IPPrefix, OspfPath>>&, OspfArea&);
template void RouteManager::deriveIntraAreaRoutes<PolicyV3>(const SpfResult&, std::vector<std::pair<IPPrefix, OspfPath>>&, OspfArea&);

template std::pair<IPPrefix, std::optional<OspfPath>> RouteManager::deriveInterAreaNetwork<PolicyV2>(OspfArea&, const LsaKey&, const LsaHeader&, const LsaBody&);
template std::pair<IPPrefix, std::optional<OspfPath>> RouteManager::deriveInterAreaNetwork<PolicyV3>(OspfArea&, const LsaKey&, const LsaHeader&, const LsaBody&);

template void RouteManager::deriveInterAreaRouter<PolicyV2>(OspfArea&, const LsaKey&, const LsaHeader&, const LsaBody&);
template void RouteManager::deriveInterAreaRouter<PolicyV3>(OspfArea&, const LsaKey&, const LsaHeader&, const LsaBody&);
