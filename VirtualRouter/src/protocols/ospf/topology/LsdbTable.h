...
public:
    ...
    LsaRecord& upsertMeta(const LsaKey& key, const LsaHeader& header, LsaRecordFlags flags);

    template <typename Body>
    Body& upsertBody(const LsaKey& key, const LsaHeader& header, LsaRecordFlags flags);
...
template <typename Body>
inline Body& LsdbTable::upsertBody(const LsaKey& key, const LsaHeader& header, LsaRecordFlags flags)
{
    LsaRecord& rec = upsertMeta(key, header, flags);
