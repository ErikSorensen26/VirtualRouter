...
using InterfaceRegistry = SubRegistry<Interface,
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::AAA_CONNECTION_INFO)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::BFD_TEMPLATE)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::DESCRIPTION)>,
    ...
    ValueField<std::vector<std::tuple<types::IPv4Prefix, std::string>> CONFIG_INDEX_ARG(Interface::IP_ADDRESS_SECONDARY), InterfaceIPAddressSecondary>,
    AtomicField<bool CONFIG_INDEX_ARG(Interface::IP_ADDRESS_DHCP), InterfaceIPAddress>,
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::IP_ADDRESS_DHCP_CLIENT_ID), InterfaceIPAddress>,
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::IP_ADDRESS_DHCP_HOSTNAME), InterfaceIPAddress>,
    ...
    ValueField<std::vector<std::tuple<types::IPv4Address, bool, std::string>> CONFIG_INDEX_ARG(Interface::IP_HELPER_ADDRESS)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::IP_POLICY_ROUTE_MAP)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::IP_TRAFFIC_EXPORT_APPLY)>,
    ...
    ValueField<std::vector<types::IPv6Address> CONFIG_INDEX_ARG(Interface::IPV6_ADDRESS)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::IPV6_POLICY_ROUTE_MAP)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::IPV6_TRAFFIC_FILTER_IN)>,
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::IPV6_TRAFFIC_FILTER_OUT)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::LAN_NAME)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::SERVICE_POLICY_INPUT)>,
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::SERVICE_POLICY_OUTPUT)>,
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::SERVICE_POLICY_CONTROL)>,
    ...
    OptionalValueField<IncompleteIf CONFIG_INDEX_ARG(Interface::STANDBY)>,
    ...
    OptionalValueField<std::string CONFIG_INDEX_ARG(Interface::VRF_FORWARDING)>,
