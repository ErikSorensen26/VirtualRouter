...
protected:
    ...
    void TearDown() override 
    {
        ...
        vrf->interfaceList[InterfaceType::GIGABIT_ETHERNET].erase(0);
    ...
    std::unordered_map<float, EigrpInterface*>& getInterfaceList() { return eigrpInstance->eigrpInterfaceList[type]; }
    ...
    std::map<InterfaceType, std::map<float, Interface*>>& getAllInterfaceList() { return vrf->interfaceList; }
};
